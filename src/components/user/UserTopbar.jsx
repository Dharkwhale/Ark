    ...
    <div className="flex items-center justify-between w-full bg-[#ffffff] px-6 py-4 border-b border-[#0bb5e0]/30">
      ...
      <div className="relative w-[250px]">
        <input
          type="text"
          placeholder="Search ..."
          className="w-full pl-10 pr-4 py-2 rounded-full bg-[#f0f2f5] text-gray-700 placeholder-gray-400 focus:outline-none"
        />
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-2 cursor-pointer">
          ...
          />
          <span className="text-[#0a0a2e] font-medium">John Doe</span>
